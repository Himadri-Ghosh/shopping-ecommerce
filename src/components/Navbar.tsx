...
const Navbar=({location, getLocation, openDropdown, setOpenDropdown}:any)=> { 
      ...
      <div className='bg-white py-3 shadow-2xl px-4 md:px-0'>
        <div className='max-w-6xl mx-auto flex justify-between items-center'>
          ...
          <div className='flex gap-7 items-center'>
              <Link to={'/'}><h1 className='text-3xl text-blue-600 font-semibold'>ShO<span className='text-red-600 font-serif'>pp</span>inG</h1></Link>
              ...
              </div>
              {
                openDropdown ? <div className='w-[250px] h-max shadow-2xl z-50 bg-white fixed top-16 left-60 border-2 p-5 border-gray-100 rounded-md'>
                    <h1 className='font-semibold mb-4 text-xl justify-between '>Change Location <span onClick={toggleDropdown}><CgClose /></span></h1>
          ...
          {/* menu section */}
              <nav className='flex gap-7 items-center'>
                ...
                <div className='hidden md:block'>
                    <SignedOut>
                      <SignInButton className="bg-red-500 text-white px-3 py-1 rounded-md cursor-pointer cl-avtarBox"/>
                    </SignedOut>
                    <SignedIn>
                      <UserButton/>
                    </SignedIn>
