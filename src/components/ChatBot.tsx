...
const Chatbot = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      let botReply = '';
      if (data.error) {
        botReply = 'Sorry, I\'m having trouble connecting. Please make sure you\'ve added your Hugging Face API token!';
      } else if (data[0]?.generated_text) {
        botReply = data[0].generated_text;
      } else {
        botReply = 'I\'m here to help! You can ask me about products, orders, or anything else.';
      }
