            ...
            >
              <div className="flex flex-col md:flex-row gap-10 justify-center h-[500px] my-25 md:my-0 items-center px-4 ">
                <div className="md:space-y-6 space-y-3">
                  ...
                  <h1 className="md:text-4xl text-xl font-bold uppercase md:line-clamp-3 line-clamp-2 md:w-[550px] text-white">
                    {item.title}
                  </h1>
                ...
                <div>
                  <img
                    src={item.images}
                    alt={item.title}
                    className="rounded-full w-[400px] hover:scale-105 transition-all shadow-2xl shadow-red-400 "
                  />
                </div>
              </div>
            </div>
