            ...
            <div>
                  ...
                  return (
                    <div
                      ...
                      <div className="bg-red-500 text-white flex gap-4 p-2 rounded-md font-bold text-xl">
                        <button className="cursor-pointer " onClick={()=>updateQuantity(item.id, item.quantity-1,"decrease")}>-</button>
                        <span>{item.quantity}</span>
                        <button className="cursor-pointer" onClick={()=>updateQuantity(item.id, item.quantity+1,"increase")}>+</button>
                      </div>
                      <span className="hover:bg-white/60 transition-all rounded-full p-3 hover:shadow-2xl">
                        <FaRegTrashAlt className="text-red-500 text-2xl cursor-pointer" onClick={()=>removeFromCart(item.id)}/>
                      </span>
                    </div>
                  );
                })}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 md:gap-20">
                <div className="bg-gray-100 rounded-md p-7 mt-4 space-y-2">
                  ...
                  <div className="flex items-center justify-center w-full text-gray-700 pb-3">
                    ----------OR----------
                  </div>
                ...
                <div className="bg-white border-gray-100 shadow-xl rounded-md p-7 mt-4 space-y-2 h-max">
                  ...
                  <div className="flex justify-between items-center ">
                    ...
                    <p className="text-red-500 font-semibold"><span className="text-gray-600 line-through pr-1">$25</span>FREE</p>
                  </div>
                  <div className="flex justify-between items-center ">
