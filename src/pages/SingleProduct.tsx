        ...
        <div className="px-4 pb-4 md:px-0">
          ...
          <div className="max-w-6xl mx-auto md:p-6 grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="text-gray-700">{singleProduct.slug?.toUpperCase()} / {singleProduct.category.name?.toUpperCase()}</div>
              <p className="text-xl text-red-500 font-bold">${singleProduct.price} <span className="line-through text-gray-700">${Math.round(singleProduct.price + (singleProduct.price * discount / 100))}</span> <span className="bg-red-500 text-white p-3 rounded-3xl">{discount}% discount</span></p>
